...
void setup_scr_pid(lv_ui *ui){
	...
	lv_style_set_text_font(&style_pid_label_1_main, LV_STATE_DEFAULT, &lv_font_simsun_20);
	...
	lv_style_set_text_font(&style_pid_label_2_main, LV_STATE_DEFAULT, &lv_font_simsun_20);
	...
	lv_style_set_text_font(&style_pid_label_3_main, LV_STATE_DEFAULT, &lv_font_simsun_20);
	...
	lv_style_set_text_font(&style_pid_P_value_bg, LV_STATE_DEFAULT, &lv_font_simsun_20);
	...
	lv_style_set_text_font(&style_pid_I_value_bg, LV_STATE_DEFAULT, &lv_font_simsun_20);
	...
	lv_style_set_text_font(&style_pid_target_bg, LV_STATE_DEFAULT, &lv_font_simsun_20);
	...
	lv_obj_set_pos(ui->pid_target, 177, 153);
	...
	//Write codes pid_btn_back_p
	ui->pid_btn_back_p = lv_btn_create(ui->pid, NULL);

	//Write style LV_BTN_PART_MAIN for pid_btn_back_p
	static lv_style_t style_pid_btn_back_p_main;
	lv_style_reset(&style_pid_btn_back_p_main);

	//Write style state: LV_STATE_DEFAULT for style_pid_btn_back_p_main
	lv_style_set_radius(&style_pid_btn_back_p_main, LV_STATE_DEFAULT, 50);
	lv_style_set_bg_color(&style_pid_btn_back_p_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(&style_pid_btn_back_p_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_dir(&style_pid_btn_back_p_main, LV_STATE_DEFAULT, LV_GRAD_DIR_VER);
	lv_style_set_bg_opa(&style_pid_btn_back_p_main, LV_STATE_DEFAULT, 255);
	lv_style_set_border_color(&style_pid_btn_back_p_main, LV_STATE_DEFAULT, lv_color_make(0x01, 0xa2, 0xb1));
	lv_style_set_border_width(&style_pid_btn_back_p_main, LV_STATE_DEFAULT, 2);
	lv_style_set_border_opa(&style_pid_btn_back_p_main, LV_STATE_DEFAULT, 255);
	lv_style_set_outline_color(&style_pid_btn_back_p_main, LV_STATE_DEFAULT, lv_color_make(0xd4, 0xd7, 0xd9));
	lv_style_set_outline_opa(&style_pid_btn_back_p_main, LV_STATE_DEFAULT, 255);
	lv_obj_add_style(ui->pid_btn_back_p, LV_BTN_PART_MAIN, &style_pid_btn_back_p_main);
	lv_obj_set_pos(ui->pid_btn_back_p, 224, 192);
	lv_obj_set_size(ui->pid_btn_back_p, 74, 36);
	ui->pid_btn_back_p_label = lv_label_create(ui->pid_btn_back_p, NULL);
	lv_label_set_text(ui->pid_btn_back_p_label, "返回");
	lv_obj_set_style_local_text_color(ui->pid_btn_back_p_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_obj_set_style_local_text_font(ui->pid_btn_back_p_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &lv_font_simsun_16);
}